...
public class PermissionsManager {
  ...
  public  final String[] VideoPermissions={Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO};
   ...
   * @param  permissions 权限所需的操作的权限。
   * @param action 将动作添加到当前正在执行的动作列表中。
   */
   ...
   * @param context 需要检查 权限的上下文
   * @param permissions 权限 数组
   * @return 返回你是否有所有的权限
   */
   ...
   *
   * @param activity 需要检查权限的activity
   * @param action permissionsresultaction用于权限接受通知你
   */
  @SuppressWarnings("unused")
   ...
   * @param  action permissionsresultaction通知当权限授予或拒绝。
   */
  @SuppressWarnings("unused")
   ...
   *将无法工作作为活动引用，必须检查权限。
   * @param  fragment 需要检查 权限的fragmnet
   ...
   * @param permissions 已更改的权限。
   * @param results 每个权限的值
   */
  @SuppressWarnings("unused")
   ...
   * @param activity 检测权限的activity
   * @param  permissions 权限数组
   * @param action 我们执行某项操作后权限检查
   */
